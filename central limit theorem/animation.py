...
# (e.g., exponential, uniform) -- distribution of property
...
def update(frame):
    ...
    sample_means = [
        np.mean(np.random.choice(population, sample_size)) for _ in range(frame)
    ]
    ...
    ax.set_title("Sampling from Uniform Dist Approaching Normal Dist")
